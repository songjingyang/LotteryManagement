...
@connect(({ systemManagement, global, loading }) => ({
  systemManagement,
  global,
  loading: loading.effects['systemManagement/getSelectMenu'],
}))
  ...
  getSelectMenu = (params = {}) => {
    this.props.form.validateFields((err, values) => {
      ...
      if (!err) {
        ...
        this.props.dispatch({
          type: 'systemManagement/getSelectMenu',
          payload: {
            ...this.props.EditData,
            ...payload,
          },
        })
        console.log('传参', payload)
      } else {
        console.log('getSelectMenu parameters error')
      }
    })
  }
  render() {
    ...
    const info = this.props.systemManagement.SelectMenu
    return (
      <Card bordered={false}>
