...
@connect(({ systemManagement, global, loading }) => ({
  systemManagement,
  global,
  loading: loading.effects['systemManagement/getAddChannelMenu'],
}))
export default class AddChannelMenu extends React.Component {
  constructor(props) {
    super(props)
    this.state = {
      data: [],
  ...
  handleSubmit = e => {
    ...
    this.props.form.validateFields((err, values) => {
      if (!err) {
        this.props.dispatch({
          type: 'systemManagement/getAddChannelMenu',
          payload: {
            ...this.props.systemManagement.AddChannelMenu,
            ...values,
